...
// Groupes de données
const allValidCodeNacs = [mockCodeNacAAA, mockCodeNacAA2, mockCodeNacAA5, mockCodeNacBB1, mockCodeNacBB2]
const subChapterAACodeNacs = [mockCodeNacAAA, mockCodeNacAA2, mockCodeNacAA5]
const subChapterBBCodeNacs = [mockCodeNacBB1, mockCodeNacBB2]
const versionsAAA = [
  mockCodeNacAAA,
  {
    ...mockCodeNacAAA,
