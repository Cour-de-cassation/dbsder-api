...
if (process.env.ATTACHMENTS_API_KEY == null) throw missingValue('process.env.ATTACHMENTS_API_KEY', new Error())
...
if (process.env.NORMALIZATION_API_KEY == null) throw missingValue('process.env.NORMALIZATION_API_KEY', new Error())
if (process.env.OPENSDER_API_KEY == null) throw missingValue('process.env.OPENSDER_API_KEY', new Error())
...
if (process.env.PUBLICATION_API_KEY == null) throw missingValue('process.env.PUBLICATION_API_KEY', new Error())
if (process.env.ZONING_API_URL == null) throw missingValue('process.env.ZONING_API_URL', new Error())
